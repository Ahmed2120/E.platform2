...
import 'package:eplatform/teacher/pages/schedule/teacher_schedule_page.dart';
import 'package:flutter/material.dart';
import 'package:scoped_model/scoped_model.dart';

import '../../pages/chat/chat_users_page.dart';
import 'chat/chat_users_page.dart';
import 'home/teacher_home_page.dart';
import 'more/teacher_more_page.dart';
import 'teacher_courses/courses_management_page.dart';

class TeacherBottomBarScreen extends StatefulWidget {
   const TeacherBottomBarScreen({Key? key}) : super(key: key);
...
class _TeacherBottomBarScreenState extends State<TeacherBottomBarScreen> {
  ...
  List<Widget> pages = [
    ...
    ScopedModelDescendant<MainModel>(
        builder:(context,child,MainModel model){
          return TeacherHomePage(model: model,);
      }
     ) ,
     ScopedModelDescendant<MainModel>(
        builder:(context,child,MainModel model){
          return CoursesManagementPage(model:  model,);
      }
    ) ,
    TeacherSchedulePage()
  ];
