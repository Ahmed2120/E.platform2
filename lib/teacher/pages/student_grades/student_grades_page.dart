...
class StudentGradesPage extends StatefulWidget {
  StudentGradesPage({Key? key}) : super(key: key);
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index)=>
                  InkWell(
                      // onTap: ()=> GlobalMethods.navigate(context, ExamStudentAnsPage()),
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Text(grade, style: Theme.of(context).textTheme.headlineLarge,),
            ],
          ),
          const Spacer(),
          Container(
