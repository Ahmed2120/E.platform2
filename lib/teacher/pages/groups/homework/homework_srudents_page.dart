...
class HomeWorkStudentsPage extends StatefulWidget {
  HomeWorkStudentsPage({Key? key}) : super(key: key);

  @override
  State<HomeWorkStudentsPage> createState() => _HomeWorkStudentsPageState();
}

class _HomeWorkStudentsPageState extends State<HomeWorkStudentsPage> {
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index)=>
                  InkWell(onTap: ()=> GlobalMethods.navigate(context, StudentAnswerPage()),
