...
class TeacherGroupsVideosPage extends StatefulWidget {
  TeacherGroupsVideosPage({ required this.model,
    required this.courseLessons,Key? key}) : super(key: key);
  MainModel model;
  CourseLessons courseLessons;
  @override
  State<TeacherGroupsVideosPage> createState() => _TeacherGroupsVideosPageState();
}

class _TeacherGroupsVideosPageState extends State<TeacherGroupsVideosPage> {
