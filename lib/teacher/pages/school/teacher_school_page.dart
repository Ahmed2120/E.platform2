...
class TeacherSchoolPage extends StatefulWidget {
  const TeacherSchoolPage({ Key? key}) : super(key: key);
  // final int schoolId;

  @override
  State<TeacherSchoolPage> createState() => _TeacherSchoolPageState();
}

class _TeacherSchoolPageState extends State<TeacherSchoolPage> {
  ...
  late CameraPosition _schoolPosition = CameraPosition(
      target: LatLng(44, 66),
      zoom: 12) ;
  late Marker _schoolMarker = Marker(
              markerId: const MarkerId('schoolMarker'),
              position: LatLng(44, 66),
            ) ;
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          return   Padding(
                            ...
                            child: ShowNetworkImage(img:'https://static.vecteezy.com/system/resources/previews/015/529/452/original/100th-day-of-school-cartoon-colored-clipart-free-vector.jpg' ),
                          );

                        }),
                  ),
                  const SizedBox(height: 10,),
                  Text('مما يؤهلهم بعد ذلك للالتحاق بالكليات العسكرية مثل الكلية الحربية والجوية والشرطة.',
