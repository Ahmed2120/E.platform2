...
import '../../../pages/videoComponant/videoPlayerScreen.dart';

class TeacherCoursesVideosPage extends StatefulWidget {
  TeacherCoursesVideosPage({ required this.model,
    required this.courseLessons,Key? key}) : super(key: key);
  MainModel model;
  CourseLessons courseLessons;
  @override
  State<TeacherCoursesVideosPage> createState() => _TeacherCoursesVideosPageState();
}

class _TeacherCoursesVideosPageState extends State<TeacherCoursesVideosPage> {
  ...
  Widget nextVideo(LessonCourseVideo video,int index) => ListTile(
    trailing:  Icon(
      Icons.check,
      ...
      children: [
        ...
        Column(
          children: [
            ...
            Text(video.Duration.toString()+'دقائق ', style: Theme.of(context).textTheme.bodySmall,),
          ],
        )
      ],
    ),
