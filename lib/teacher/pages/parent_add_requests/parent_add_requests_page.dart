...
import 'parent_requests_content_page.dart';

class ParentAddRequestsPage extends StatelessWidget {
  ParentAddRequestsPage({Key? key}) : super(key: key);
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index)=>
                  InkWell(
                      onTap: ()=> GlobalMethods.navigate(context, ParentRequestsContentPage()),
