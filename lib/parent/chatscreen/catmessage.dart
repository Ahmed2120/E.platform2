...
class ChatMsgPPage extends StatefulWidget {
  ChatMsgPPage({Key? key}) : super(key: key);

  @override
  State<ChatMsgPPage> createState() => _ChatMsgPPageState();
}

class _ChatMsgPPageState extends State<ChatMsgPPage> {
