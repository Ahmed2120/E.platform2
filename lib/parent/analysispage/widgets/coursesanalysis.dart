...
String getTextBasedOnIndex(int index) {
  if (index == 0) {
    return 'كورس أ/ احمد خالد';
  } else if (index == 1) {
    return 'كورس أ/ عاطف محمود ';
  } else if (index == 2) {
    return ' كورس أ/علاء يوسف ';
  } else if (index == 3) {
    return ' كورس أ/ممدوح احمد';
  }
  //
  return 'كورس أ/ممدوح احمد';
}
...
class CoursesAnalysis extends StatefulWidget {
  CoursesAnalysis({Key? key}) : super(key: key);

  @override
  State<CoursesAnalysis> createState() => _CoursesAnalysisState();
}

class _CoursesAnalysisState extends State<CoursesAnalysis> {
