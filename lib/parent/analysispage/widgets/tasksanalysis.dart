...
class TasksAnalysis extends StatefulWidget {
  TasksAnalysis({Key? key}) : super(key: key);

  @override
  State<TasksAnalysis> createState() => _TasksAnalysisState();
}

class _TasksAnalysisState extends State<TasksAnalysis> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      analysistaskscontainer(
                        context,
                        'اجمالي فتح الاختبارات',
                        .9,
                        '90',
                        Color(0xFFB3716F),
                      ),
  ...
  Container analysistaskscontainer(
      context, String title, double percentage, String percText, Color color) {
    return Container(
      padding: const EdgeInsets.all(15),
      margin: const EdgeInsets.symmetric(vertical: 10, horizontal: 2),
      decoration: BoxDecoration(
