...
import 'package:eplatform/parent/addingteacherspage/addingteacherscontent.dart';
import 'package:eplatform/parent/custom%20widgets/customtextformfield.dart';
import 'package:flutter/material.dart';

class AddingTeachers extends StatelessWidget {
  AddingTeachers({Key? key}) : super(key: key);
                      ...
                      itemBuilder: (context, index) => InkWell(
                          onTap: () {
                            GlobalMethods.navigate(
                                context, AddingTeachersContent());
                          },
                          child: addingteacheritem(
                            context,
                          )),
                    ),
                  ],
  ...
  Widget addingteacheritem(context) => Container(
