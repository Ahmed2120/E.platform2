...
import 'package:eplatform/parent/coursesandgroupsppage/coursescontentdetailsp.dart';
import 'package:eplatform/parent/coursesandgroupsppage/groupscontentcandgp.dart';
...
class CoursesAndGroupsOfChildrens extends StatefulWidget {
  CoursesAndGroupsOfChildrens({Key? key}) : super(key: key);

  @override
  State<CoursesAndGroupsOfChildrens> createState() =>
      _CoursesAndGroupsOfChildrensState();
}

class _CoursesAndGroupsOfChildrensState
    extends State<CoursesAndGroupsOfChildrens> {
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => InkWell(
                                onTap: () => GlobalMethods.navigate(
                                    context, CoursesContentForCoursGrouPage()),
                                child:
                                    corssesSugestionscontainer(context, index)),
                          ),
                        )
                            ...
                            itemBuilder: (context, index) => InkWell(
                                onTap: () {
                                  GlobalMethods.navigate(context,
                                      ChildernGroupsContentForGandCPPage());
                                },
                                child: InkWell(
                                  onTap: () {
                                    updateSelectedItem(index);
                                  ...
                                  child:
                                      GroupsSuggestionContainer(context, index),
                                )),
                          ),
                        ),
                      const SizedBox(
  ...
  Widget GroupsSuggestionContainer(context, int i) => InkWell(
        onTap: () {
...
Widget corssesSugestionscontainer(context, int i) => Container(
    padding: const EdgeInsets.all(15),
    margin: const EdgeInsets.symmetric(vertical: 10, horizontal: 2),
    decoration: BoxDecoration(
      border: const Border(
