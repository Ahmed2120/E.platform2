...
import 'package:eplatform/parent/chatscreen/chatscreen.dart';
...
import 'subjectsscreen/subjectsceen.dart';

class BottomBarParentsScreen extends StatefulWidget {
  const BottomBarParentsScreen({Key? key}) : super(key: key);

  @override
  State<BottomBarParentsScreen> createState() => _BottomBarParentsScreenState();
}

class _BottomBarParentsScreenState extends State<BottomBarParentsScreen> {
