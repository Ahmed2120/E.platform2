...
class TasksAbcences extends StatefulWidget {
  TasksAbcences({Key? key}) : super(key: key);

  @override
  State<TasksAbcences> createState() => _TasksAbcencesState();
}

class _TasksAbcencesState extends State<TasksAbcences> {
  ...
  String getUnitsBasedOnIndex(int index) {
    if (index == 0) {
      return ' الوحده الاولي';
    } else if (index == 1) {
      return '    الوحده  الثانيه  ';
    } else if (index == 2) {
      return '   الوحده الثالثه  ';
    } else if (index == 3) {
      return ' الوحده الرابعه ';
    }
    //
    return 'الوحده الاولي';
  }
