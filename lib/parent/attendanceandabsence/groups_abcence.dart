...
List<String> lessonstext = ['الحصه الاولي', 'الحصه الثانيه', 'الحصه الثالثه'];
...
class GroupsAbsence extends StatefulWidget {
  GroupsAbsence({Key? key}) : super(key: key);

  @override
  State<GroupsAbsence> createState() => _GroupsAbsenceState();
}

class _GroupsAbsenceState extends State<GroupsAbsence> {
                      ...
                      if (type == ContentType.course)
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => InkWell(
                                onTap: () {},
                                child: attendanceContainer(context, index)),
                          ),
                        )
                      ...
                      // ---------------------- لم يتم الحضور ------------------
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => InkWell(
                                onTap: () {},
                                child: absencecontainer(context, index)),
                          ),
                        ),
                      const SizedBox(
                        height: 10,
  ...
  Widget subSubjectContainer() => Expanded(
      child: Padding(
...
Widget attendanceContainer(context, int i) => Container(
...
Widget absencecontainer(context, int i) => Container(
    padding: const EdgeInsets.all(15),
    margin: const EdgeInsets.symmetric(vertical: 10, horizontal: 2),
    decoration: BoxDecoration(
      border: const Border(
