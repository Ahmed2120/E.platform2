...
import 'group_content_page.dart';
import 'lessons_page.dart';

class GroupsPage extends StatelessWidget {
  GroupsPage({required this.model,required this.group,  Key? key}) : super(key: key);
  MainModel model;
  Group group;
          ...
          builder:(context,child,MainModel model){
            return CustomStack(
              ...
              child: model.TeacherGroupsLoading==true?
                 ...
                 child: ListView.builder(
                   ...
                   itemBuilder: (context, index)=> InkWell(
                       onTap: (){ GlobalMethods.navigate(context,
                           GroupContentPage(model:model,teacherGroups: model.TeacherGroupsList[index],index: index,));
               ...
               const SizedBox(height: 12,),
               CustomElevatedButton(title: 'احجز موعد', function: ()=> GlobalMethods.navigate(context,
                   BookAppointmentPage(teacherId:group.TeacherId,teacherName: group.TeacherName ,)))
                  ],
                ),
      ); })
    );
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Column(
            children:  [
              Text( GlobalMethods.showPrice(teacherGroups.Price.toString())),
