...
class FilterDialog extends StatelessWidget {
      ...
      content: Column(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              SizedBox(height: 15,),
              Text('فروع المادة', style: Theme.of(context).textTheme.titleMedium,),
              SizedBox(height: 15,),
              Wrap(
                spacing: 6,
                runSpacing: 6,
  ...
  Container subjectContainer(BuildContext context, subject) {
    return Container(
          ...
          child: Text(subject.name, style: TextStyle(color: subject.isActive ? Colors.white : AppColors.primaryColor),),
        );
  }
